...
<div className="grid grid-cols-2 grid-rows-10 gap-2 h-full mt-5">
  ...
  <div className="col-span-2">
    <details>
      <summary className="font-bold text-base mb-2">Coarse Fishing</summary>
  ...
  <div className="col-span-2">
    <details>
      <summary className="font-bold text-base mb-2">Carp Fishing</summary>
      <div className="grid grid-cols-2 gap-2 mt-2">
        <div className="flex items-center gap-2">
  ...
  <div className="col-span-2">
    <details>
      <summary className="font-bold text-base mb-2">Match Fishing</summary>
      <div className="grid grid-cols-2 gap-2 mt-2">
        <div className="flex items-center gap-2">
