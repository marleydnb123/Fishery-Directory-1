      ...
      <Link to={`/directory/${fishery.slug}`} className="block h-full" onClick={handleScrollTop}>
        ...
        <div className="p-6 flex flex-col h-full">
          <div className="flex items-start justify-between">
            <h3 className="text-4xl font-bebas font-semibold text-gray-900 text-center mb-2">{fishery.name}</h3>
          </div>
          ...
          <p className="text-gray-600 mb-2 line-clamp-2 min-h-[2.5rem]">{fishery.description}</p>
