  ...
  <div className="container mx-auto max-w-6xl">
    ...
    <div className="flex flex-col md:flex-row items-stretch justify-center gap-12"> 
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <div className="relative bg-gradient-to-br from-blue-100 via-white to-blue-50 border border-blue-200 rounded-3xl shadow-2xl p-8 w-full min-w-[600px] max-w-[600px] min-h-[600px] max-w-[600px] flex flex-col justify-between transition-transform hover:scale-[1.025] hover:shadow-blue-200/40">
          {loading_fotw ? (
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <div className="relative bg-gradient-to-br from-blue-100 via-white to-blue-50 border border-blue-200 rounded-3xl shadow-2xl p-8 w-full min-w-[600px] max-w-[600px] flex flex-col justify-between transition-transform hover:scale-[1.025] hover:shadow-blue-200/40">
          <img
