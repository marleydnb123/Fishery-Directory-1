              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-700 mb-3">Fishing Options</h4>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-center">
                        <input
                          ...
                          id="nightFishing"
                        />
                        <label htmlFor="nightFishing" className="text-sm">Night Fishing</label>
                      </div>
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          ...
                          id="matchFishing"
                        />
                        <label htmlFor="matchFishing" className="text-sm">Match Fishing</label>
                      </div>
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                  ...
                  {/* Facilities */}
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-700 mb-3">Facilities</h4>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex items-center">
                        <input
                          type="checkbox"
