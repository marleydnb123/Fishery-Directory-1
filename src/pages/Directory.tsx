            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-xl text-left  hover:rounded-xl transition-colors"
                >
              ...
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-1 text-left rounded-xl text-left hover:rounded-xl transition-colors"
                >
