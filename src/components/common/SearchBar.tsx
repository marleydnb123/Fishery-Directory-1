    ...
    >
      <div className="relative">
        <input
          ...
          className="w-full py-3 pl-12 pr-4 text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent"
        />
