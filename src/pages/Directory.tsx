      ...
      <div className="container mx-auto px-4 pb-8" style={{ marginTop: '3rem' }}>
        ...
        <div className="bg-customBlue/50 rounded-xl shadow-md p-6 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            // Coarse, Carp, and Match Fishing Options (Collapsible Sections)

<div className="space-y-4">

  {/* Coarse Fishing */}
  <details>
    <summary className="font-bold text-base">Coarse Fishing Options</summary>
  ...
  {/* Carp Fishing */}
  <details>
    <summary className="font-bold text-base">Carp Fishing Options</summary>
    <div className="grid grid-cols-2 gap-2 mt-3">
  ...
  {/* Match Fishing */}
  <details>
    <summary className="font-bold text-base">Match Fishing Options</summary>
    <div className="grid grid-cols-2 gap-2 mt-3">
      {/* Match Fishing Friendly */}
      <div className="flex items-center gap-2">
        <input
          type="checkbox"
