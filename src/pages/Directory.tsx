...
<div className="mb-6">
  <h3 className="text-sm font-semibold text-gray-800 mb-3">Coarse Fishing</h3>
...
<div className="mb-6">
  <h3 className="text-sm font-semibold text-gray-800 mb-3">Carp Fishing</h3>
  <div className="grid grid-cols-2 gap-2">
    <div className="flex items-center gap-2">
      <input
        type="checkbox"
...
<div className="mb-6">
  <h3 className="text-sm font-semibold text-gray-800 mb-3">Match Fishing</h3>
  <div className="grid grid-cols-2 gap-2">
    <div className="flex items-center gap-2">
      <input
        type="checkbox"
