...
<section className="py-20 px-4 bg-gradient-to-b from-blue-50 via-white to-blue-100">
  <div className="container mx-auto max-w-6xl">
    {/* Section Title */}
    <h2 className="text-6xl font-bebas font-bold text-gray-900 mb-2 text-center">
      Weekly Highlights
    </h2>
    {/* Two-column layout */}
    <div className="flex flex-col md:flex-row items-stretch gap-12">
      ...
      <div className="hidden md:flex items-center px-0">
        <div className="h-300 w-1 bg-blue-700 rounded-full mx-auto" style={{ minHeight: '400px' }}></div>
      </div>
